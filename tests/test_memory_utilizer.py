...
import pytest
from cryptojacker_payload.memory_utilizer import (
...
def set_system_virtual_memory(
    ...
    monkeypatch.setattr(
        "cryptojacker_payload.memory_utilizer.psutil.virtual_memory",
...
def set_consumed_virtual_memory(monkeypatch, vms: int):
    monkeypatch.setattr(
        "cryptojacker_payload.memory_utilizer.psutil.Process",
